...
<div class="row justify-content-center align-items-center">
        <div class="col-xs-12 col-sm-12 col-md-8 well well-sm formulaire">
            <h3 class="text-center text-dark mb-1">Mot de passe oublié</h3>
	<spring:url value="/utilisateur/savePassword" var="utilisateurActionUrl"/>

	<form:form id="passwordform" name="frm" 
	...
	action="${utilisateurActionUrl}">
		...
		<spring:bind path="matricule">
			...
			<div class="col-xs-6 col-md-6">
				...
				<label>Quel était votre matricule?*</label>
		...
		<spring:bind path="email">
                ...
                <div class="col-xs-6 col-md-6">
                   <div class="form-group">
                       	<label for="email" class="text-dark">Quel était votre email?*</label><br>
		...
		<div class="row">
                <div class="col-xs-6 col-md-6">
                   <div class="form-group">
                        <label for="username" class="text-dark">Quel est votre nom?*</label><br>
                ...
                <div class="col-xs-6 col-md-6">
                   <div class="form-group">
                        <label for="username" class="text-dark">Quel est votre prénom?*</label><br>
		...
		<div class="col-xs-6 col-md-6">
			<div class="form-group">
               <label for="username" class="text-dark">Quel est votre numéro de téléphone?*</label><br>
                  <div class="form-group input-group"> 
		...
		<div class="row">
			<div class="col-xs-6 col-md-6">
				<div class="form-group">
						...
						<label for="username" class="text-dark">Quel est votre rôle?*</label><br>
		                  <div class="form-group input-group"> 
		...
		<spring:bind path="mdp">
			<div class="row">
                ...
                <div class="col-xs-6 col-md-6">
                   <div class="form-group">
                        <label for="password" class="text-dark">Confirmation du nouveau mot de passe*</label><br>
