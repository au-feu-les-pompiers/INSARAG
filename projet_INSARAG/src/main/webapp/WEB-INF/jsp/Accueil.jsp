				...
				<c:choose>
					<c:when test="${utilisateurForm.enMission == 1}">
						...
						<div class="text-center mt-3 mb-3">
							<button class="btn btn-warning"	onclick="location.href='/mission/get/${missionToShow.idMission}'">Voir la mission</button>
						</div>
					...
					<c:otherwise>
					<button class="btn btn-lg btn-warning btn-block mt-3"	onclick="location.href='/mission/get/${missionToShow.idMission}'">Voir la mission</button><br/>
